...
> 契约真值口径：宝付官方文档是请求/响应/回调/枚举/错误码/ACK 的唯一真值。`artifacts/baofu-payment/baofu-contract-source-matrix.md` 记录每个首版接口对应的官方页、辅助材料和待确认项；sandbox、日志和 Java demo 只能作为兼容性证据或问题线索，不能单独定义生产契约。
