...
- Preserved the open risks explicitly: union-gw official envelope/数字信封/响应验签, worker/scheduler production client wiring, combined-payment strategy, refund callback/query recovery, full official error-code tables, and real sandbox evidence.
