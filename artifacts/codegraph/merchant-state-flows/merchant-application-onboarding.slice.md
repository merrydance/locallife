...
Status: merchant-state flow slice created; owner-only approval lookup fixed 2026-06-07; read-only `/v1/merchants/applications/me` compatibility route verified 2026-06-11; mutating `GET /v1/merchant/application` submitted-reset race fixed 2026-06-11; explicit edit/reset queued-review supersede fixed 2026-06-11
