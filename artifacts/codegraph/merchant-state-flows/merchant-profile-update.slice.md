...
Status: third merchant-state flow slice; category replacement and shop-image latest-row scoping fixes applied 2026-06-06; Logo conflict recovery, shop-image pending-sync proof, merchant-owned live shop-image truth, and already-applied schema hardening applied 2026-06-07
...
- Fixed 2026-06-07: migration `000250` closes already-applied weaker `000249` schema drift by dropping/recreating the live storefront/environment constraints, nulling invalid live merchant image JSON, and preserving only valid `NULL` or string-array/count-conformant live values before the stricter constraints are added.
