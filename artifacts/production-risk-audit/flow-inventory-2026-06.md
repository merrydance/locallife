...
| 3 | CUSTOMER-DINE-IN-CHECKOUT | G3 | `artifacts/codegraph/customer-state-flows/customer-dine-in-session-menu-checkout.slice.md` | `artifacts/codegraph/customer-state-flows/customer-dine-in-session-menu-checkout.edges.json` | source-audited, fixed | source-audited, fixed | slice-ledgered | source-audited, fixed | slice-ledgered | slice-ledgered |
