...
| --- | --- | --- | --- |
| TC-BACKLOG-001 | Dine-in checkout | Paid order to session checkout convergence is now source-audited; both customer checkout and backend recovery use `CloseDiningSessionTx`. | Keep Mini Program E2E/context proof and recovery failure observability as follow-ups; rerun focused DB/scheduler tests before transaction changes. |
