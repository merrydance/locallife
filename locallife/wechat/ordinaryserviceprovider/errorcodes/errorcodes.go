...
func categoryFor(code string, statusCode int) Category {
	switch code {
	case "SYSTEM_ERROR", "SYSTEMERROR", "FREQUENCY_LIMITED", "RATE_LIMITED", "RATELIMIT_EXCEEDED", "BANK_ERROR":
	...
	case "NOT_ENOUGH", "RESOURCE_ALREADY_EXISTS", "RESOURCE_NOT_EXISTS", "ORDER_NOT_EXIST", "ORDER_CLOSED", "OUT_TRADE_NO_USED", "PROCESSING":
