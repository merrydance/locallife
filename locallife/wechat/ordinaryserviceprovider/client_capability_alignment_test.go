...
var ordinaryClientEndpointCoverage = map[contracts.EndpointID]string{
	...
	contracts.EndpointAccountWillingnessSubmit:           "Client.SubmitAccountWillingness",
	contracts.EndpointAccountWillingnessCancel:           "Client.CancelAccountWillingness",
	contracts.EndpointAccountWillingnessQuery:            "Client.QueryAccountWillingness",
	contracts.EndpointAccountAuthorizeState:              "Client.QueryAccountAuthorizeState",
	contracts.EndpointAccountWillingnessMediaUpload:      "Client.UploadImage",
