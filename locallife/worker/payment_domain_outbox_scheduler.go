...
var defaultPaymentDomainOutboxSchedulerEventTypes = []string{
	...
	db.PaymentDomainOutboxEventApplymentActivated,
	db.PaymentDomainOutboxEventApplymentPendingStateReady,
	db.PaymentDomainOutboxEventApplymentTerminalStateReady,
