...
func TestLoadConfig_ReadsWechatPaymentAndEcommerceConfig(t *testing.T) {
	...
	require.Equal(t, "https://example.com/ecommerce/notify", config.WechatEcommerceNotifyURL)
...
func TestEffectiveWechatEcommerceNotifyURLs(t *testing.T) {
	...
	require.Equal(t, "https://example.com/v1/webhooks/wechat-ecommerce/notify", config.EffectiveWechatEcommerceNotifyURL())
	...
	config.WechatEcommerceNotifyURL = "https://override.example.com/ecommerce/notify"
	config.WechatEcommerceRefundNotifyURL = "https://override.example.com/ecommerce/refund-notify"

	require.Equal(t, "https://override.example.com/ecommerce/notify", config.EffectiveWechatEcommerceNotifyURL())
