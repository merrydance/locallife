...
func createDirectRefundContract(ctx context.Context, paymentClient wechat.PaymentClientInterface, req *wechatcontracts.DirectRefundRequest) (*wechatcontracts.DirectRefundResponse, error) {
