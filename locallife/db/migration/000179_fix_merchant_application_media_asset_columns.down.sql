...
BEGIN
    IF EXISTS (
        ...
        ALTER TABLE merchant_applications
            RENAME COLUMN id_card_front_media_asset_id TO legal_person_id_front_media_asset_id;
    END IF;
    ...
    IF EXISTS (
        ...
        ALTER TABLE merchant_applications
            RENAME COLUMN id_card_back_media_asset_id TO legal_person_id_back_media_asset_id;
    END IF;
END $$;