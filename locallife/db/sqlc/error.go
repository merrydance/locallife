...
var ErrInvalidTagName = errors.New("tag name is invalid")
var ErrMerchantSelectableTagUnavailable = errors.New("merchant selectable tag is unavailable")
var ErrTagNameReservedInactive = errors.New("tag name is reserved by inactive tag")
var ErrTagTypeNotSelectable = errors.New("tag type is not merchant selectable")
