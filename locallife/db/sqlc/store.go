...
type Store interface {
	...
	CreateBaofuWithdrawalOrderWithReservationAndSubmittedCommandTx(ctx context.Context, arg CreateBaofuWithdrawalOrderWithReservationAndSubmittedCommandTxParams) (CreateBaofuWithdrawalOrderWithReservationAndSubmittedCommandTxResult, error)
	ApplyBaofuWithdrawalTerminalStatusTx(ctx context.Context, arg ApplyBaofuWithdrawalTerminalStatusTxParams) (ApplyBaofuWithdrawalTerminalStatusTxResult, error)
