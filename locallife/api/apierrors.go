...
var (
	...
	ErrMerchantFoodPermitSubjectMismatch     = apierr(40106, "食品经营许可证主体信息与营业执照不一致，请核对后重试")
...
var (
	ErrSettlementAccountBankUnsupported = apierr(40062, "当前开户银行不在宝付结算账户银行目录中，请重新选择银行后提交")
...
var (
	...
	ErrApplymentWechatNoAuth                    = apierr(40363, "微信支付进件权限未开通，请联系平台管理员开通权限后重试")
	...
	ErrApplymentWechatSignError                 = apierr(50217, "微信支付进件签名校验失败，请联系平台管理员检查证书、公钥和商户号配置后重试")
...
var (
	...
	ErrSettlementServiceUnavailable  = apierr(50304, "结算账户服务暂不可用，请联系平台管理员检查宝付配置后重试")
)
