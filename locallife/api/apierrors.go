...
var (
	...
	ErrSettlementWechatRequestRejected    = apierr(50211, "wechat settlement account request was rejected")
	ErrSettlementWechatServiceUnavailable = apierr(50212, "wechat settlement account service is temporarily unavailable")
