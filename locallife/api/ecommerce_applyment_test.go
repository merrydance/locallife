...
func writeTestUploadImage(t *testing.T, filename string, data []byte) string {
	t.Helper()
	dir := filepath.Join("uploads", "test")
...
func TestMerchantBindBankAPI(t *testing.T) {
	...
	idFrontPath := writeTestUploadImage(t, "id_front.jpg", minJPEG)
	idBackPath := writeTestUploadImage(t, "id_back.jpg", minJPEG)
	licensePath := writeTestUploadImage(t, "license.jpg", minJPEG)

	// 更新申请记录使用本地上传路径
	applicationWithTestURL := application
	applicationWithTestURL.LegalPersonIDFrontUrl = idFrontPath
	applicationWithTestURL.LegalPersonIDBackUrl = idBackPath
	applicationWithTestURL.BusinessLicenseImageUrl = licensePath
...
func TestMerchantBindBankUploadImageFailed(t *testing.T) {
	...
	idFrontPath := writeTestUploadImage(t, "merchant_id_front.jpg", minJPEG)
	idBackPath := writeTestUploadImage(t, "merchant_id_back.jpg", minJPEG)
	licensePath := writeTestUploadImage(t, "merchant_license.jpg", minJPEG)
...
func TestMerchantBindBankEncryptFailed(t *testing.T) {
	...
	idFrontPath := writeTestUploadImage(t, "merchant_id_front_encrypt.jpg", minJPEG)
	idBackPath := writeTestUploadImage(t, "merchant_id_back_encrypt.jpg", minJPEG)
	licensePath := writeTestUploadImage(t, "merchant_license_encrypt.jpg", minJPEG)
