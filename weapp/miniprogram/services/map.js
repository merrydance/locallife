...
class MapService {
  ...
  createMarker(id, point, label, iconPath, options) {
    return {
      ...
      width:
        (options === null || options === void 0 ? void 0 : options.width) || 40,
      height:
  ...
  createPolyline(points, options) {
    return {
      ...
      color:
        ...
        "#1d63ff",
      width:
        (options === null || options === void 0 ? void 0 : options.width) || 6,
      dottedLine:
        (options === null || options === void 0
          ? void 0
          : options.dottedLine) || false,
      arrowLine:
        (options === null || options === void 0 ? void 0 : options.arrowLine) ||
        false,
    };
  }
  /**
  ...
  reverseGeocode(point) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        const locationInfo = yield location_1.locationService.reverseGeocode(
          point.latitude,
          point.longitude,
        );
        const address =
