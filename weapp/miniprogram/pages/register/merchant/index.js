...
Page({
    ...
    async initApplication() {
        ...
        try {
            const res = await (0, onboarding_1.getMerchantApplication)();
            ...
            const formData = {
                ...
                // OCR 回填
                licenseName: safeStr((_a = data.business_license_ocr) === null || _a === void 0 ? void 0 : _a.enterprise_name),
                creditCode: safeStr(data.business_license_number || ((_b = data.business_license_ocr) === null || _b === void 0 ? void 0 : _b.reg_num) || ((_c = data.business_license_ocr) === null || _c === void 0 ? void 0 : _c.credit_code)),
                registerAddress: safeStr((_d = data.business_license_ocr) === null || _d === void 0 ? void 0 : _d.address),
                licenseValidity: safeStr((_e = data.business_license_ocr) === null || _e === void 0 ? void 0 : _e.valid_period),
                businessScope: safeStr(data.business_scope || ((_f = data.business_license_ocr) === null || _f === void 0 ? void 0 : _f.business_scope)),
                foodLicenseValidity: safeStr((_g = data.food_permit_ocr) === null || _g === void 0 ? void 0 : _g.valid_to),
                legalPerson: safeStr(((_h = data.id_card_front_ocr) === null || _h === void 0 ? void 0 : _h.name) || data.legal_person_name || ((_j = data.business_license_ocr) === null || _j === void 0 ? void 0 : _j.legal_representative)),
                idCard: safeStr(((_k = data.id_card_front_ocr) === null || _k === void 0 ? void 0 : _k.id_number) || data.legal_person_id_number),
                gender: safeStr((_l = data.id_card_front_ocr) === null || _l === void 0 ? void 0 : _l.gender),
                hometown: safeStr((_m = data.id_card_front_ocr) === null || _m === void 0 ? void 0 : _m.address),
                idCardValidity: safeStr((_o = data.id_card_back_ocr) === null || _o === void 0 ? void 0 : _o.valid_date),
            ...
            const safeResolve = async (url) => {
                if (!url)
                    return '';
                try {
                    return await resolveImageURL(url);
                }
                catch (_a) {
                    return '';
                }
    ...
    async syncToBackend() {
        ...
        try {
            ...
            await (0, onboarding_1.updateMerchantBasicInfo)(payload);
    ...
    async onLicenseUpload(e) {
        ...
        try {
            // 上传并触发异步 OCR
            const result = await (0, onboarding_1.ocrBusinessLicense)(path);
    ...
    async onFoodLicenseUpload(e) {
        ...
        wx.showLoading({ title: '上传中...' });
        try {
            const result = await (0, onboarding_1.ocrFoodPermit)(path);
    ...
    async onIdCardFrontUpload(e) {
        ...
        wx.showLoading({ title: '上传中...' });
        try {
            const result = await (0, onboarding_1.ocrIdCard)(path, 'Front');
    ...
    async onIdCardBackUpload(e) {
        ...
        wx.showLoading({ title: '上传中...' });
        try {
            const result = await (0, onboarding_1.ocrIdCard)(path, 'Back');
    ...
    // ==================== 门头照/环境照上传 ====================
    async onStorefrontImageUpload(e) {
    ...
    async onStorefrontImageRemove(e) {
    ...
    async onEnvironmentImageUpload(e) {
        // t-upload bind:add 传递的是 files 数组
        const files = e.detail.files;
        if (!files || files.length === 0) {
    ...
    async onEnvironmentImageRemove(e) {
        const { index } = e.detail;
    ...
    async onSubmit() {
        ...
        try {
            ...
            const result = await (0, onboarding_1.submitMerchantApplication)();
    ...
    startPollingStatus() {
        ...
        const intervalId = setInterval(async () => {
            attempts++;
            try {
                const res = await (0, onboarding_1.getMyApplication)();
    ...
    async onResetApplication() {
        try {
            ...
            await (0, onboarding_1.resetMerchantApplication)();
            wx.hideLoading();
