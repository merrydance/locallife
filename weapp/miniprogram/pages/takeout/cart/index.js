...
Page({
    ...
    loadAllCarts() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                // 获取用户所有购物车汇总
                const userCarts = yield CartAPI.getUserCarts();
                ...
                for (const merchantCart of userCarts.carts) {
                    if (!merchantCart.merchant_id)
                        continue;
                    try {
                        const cartDetail = yield CartAPI.getCart(merchantCart.merchant_id);
    ...
    syncToGlobalStore() {
        ...
        logger_1.logger.debug('Cart synced to globalStore', { totalCount }, 'cart.syncToGlobalStore');
    },
    /**
     * 构建商户购物车组
     */
