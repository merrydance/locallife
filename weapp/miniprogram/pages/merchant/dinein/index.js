...
Page({
    ...
    async loadData() {
        ...
        try {
            // 获取桌台列表
            const result = await table_device_management_1.tableManagementService.listTables('table');
    ...
    onOpenTable(e) {
        ...
        wx.showModal({
            ...
            success: async (res) => {
                if (res.confirm) {
                    try {
                        await table_device_management_1.tableManagementService.updateTableStatus(id, { status: 'occupied' });
    ...
    onCloseTable(e) {
        ...
        wx.showModal({
            ...
            success: async (res) => {
                if (res.confirm) {
                    try {
                        await table_device_management_1.tableManagementService.updateTableStatus(id, { status: 'available' });
