...
Page({
    ...
    async loadMerchantInfo() {
        try {
            ...
            // 处理 logo_url 确保能正确显示
            if (res.logo_url) {
                res.logo_url = await (0, image_security_1.resolveImageURL)(res.logo_url);
            }
            this.setData({
                merchant: res,
    ...
    async uploadLogo() {
        try {
            ...
            const logoUrl = await (0, image_security_1.resolveImageURL)(uploadRes);
