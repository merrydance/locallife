...
Page({
    ...
    async loadExceptions() {
        ...
        try {
            ...
            const res = await rider_exception_handling_1.riderExceptionHandlingService.getRiderAppeals({ page_id: 1, page_size: 20 });
    ...
    async onConfirm() {
        ...
        try {
            ...
            await rider_exception_handling_1.riderExceptionHandlingService.reportException(formData.order_id, {
