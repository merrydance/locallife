...
Page({
    ...
    loadPaymentByOrder(orderId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                // 通过订单ID获取支付列表，取第一条
                const { getPayments } = yield Promise.resolve().then(() => __importStar(require('../../../api/payment-refund')));
                const result = yield getPayments({ order_id: orderId, page: 1, page_size: 1 });
