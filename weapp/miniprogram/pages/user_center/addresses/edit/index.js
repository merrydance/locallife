...
Page({
    ...
    async loadAddress(id) {
        try {
            const detail = await address_1.default.getAddressDetail(id);
            this.setData({
    ...
    async onSave() {
        ...
        try {
            if (this.data.addressId) {
                ...
                await address_1.default.updateAddress(this.data.addressId, updateData);
                // 如果需要设为默认
                if (this.data.isDefault) {
                    await address_1.default.setDefaultAddress(this.data.addressId);
                }
            }
            else {
                // 创建地址
                ...
                await address_1.default.createAddress(createData);
            }
            ...
            const err = error;
            const message = (err === null || err === void 0 ? void 0 : err.message) || ((_b = (_a = err === null || err === void 0 ? void 0 : err.response) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.error) || ((_c = err === null || err === void 0 ? void 0 : err.data) === null || _c === void 0 ? void 0 : _c.error);
    ...
    async onDelete() {
        ...
        wx.showModal({
            ...
            success: async (res) => {
                if (res.confirm) {
                    try {
                        await address_1.default.deleteAddress(this.data.addressId);
