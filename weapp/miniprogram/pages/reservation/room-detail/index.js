...
Page({
    ...
    async loadRoomDetail(id) {
        ...
        try {
            const room = await (0, reservation_1.getRoomDetail)(id);
            // 预处理价格
            const processedRoom = {
                ...room,
                minSpendDisplay: (0, util_1.formatPriceNoSymbol)(room.min_spend || 0),
                depositDisplay: (0, util_1.formatPriceNoSymbol)(room.deposit || 0)
            };
            this.setData({
                room: processedRoom,
                loading: false
