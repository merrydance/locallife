...
class VoucherManagementService {
     ...
     * @param params 查询参数
     */
    async listVouchers(merchantId, params) {
     ...
     * @param merchantId 商户ID
     */
    async listActiveVouchers(merchantId) {
        return (0, request_1.request)({
     ...
     */
    async createVoucher(merchantId, voucherData) {
        return (0, request_1.request)({
            url: `/v1/merchants/${merchantId}/vouchers`,
            method: 'POST',
            data: voucherData
     ...
     */
    async updateVoucher(merchantId, voucherId, voucherData) {
        return (0, request_1.request)({
     ...
     * @param voucherId 优惠券ID
     */
    async deleteVoucher(merchantId, voucherId) {
        return (0, request_1.request)({
            url: `/v1/merchants/${merchantId}/vouchers/${voucherId}`,
            method: 'DELETE'
        });
...
class RechargeRuleManagementService {
     ...
     * @param merchantId 商户ID
     */
    async listRechargeRules(merchantId) {
        return (0, request_1.request)({
     ...
     * @param merchantId 商户ID
     */
    async listActiveRechargeRules(merchantId) {
        return (0, request_1.request)({
     ...
     */
    async createRechargeRule(merchantId, ruleData) {
        return (0, request_1.request)({
            url: `/v1/merchants/${merchantId}/recharge-rules`,
            method: 'POST',
            data: ruleData
     ...
     * @param ruleData 更新数据
     */
    async updateRechargeRule(merchantId, ruleId, ruleData) {
        return (0, request_1.request)({
     ...
     * @param ruleId 规则ID
     */
    async deleteRechargeRule(merchantId, ruleId) {
        return (0, request_1.request)({
            url: `/v1/merchants/${merchantId}/recharge-rules/${ruleId}`,
            method: 'DELETE'
        });
...
class MembershipSettingsService {
     ...
     */
    async updateMembershipSettings(settingsData) {
        return (0, request_1.request)({
            url: '/v1/merchants/me/membership-settings',
            method: 'PUT',
            data: settingsData
...
class PromotionManagementService {
     ...
     * @param merchantId 商户ID
     */
    async getDeliveryFeePromotions(merchantId) {
        return (0, request_1.request)({
     ...
     */
    async createDeliveryFeePromotion(merchantId, promotionData) {
        return (0, request_1.request)({
            url: `/delivery-fee/merchants/${merchantId}/promotions`,
            method: 'POST',
            data: promotionData
     ...
     */
    async deleteDeliveryFeePromotion(merchantId, promotionId) {
        return (0, request_1.request)({
 ...
 * @param merchantId 商户ID
 */
async function getAllMarketingTools(merchantId) {
 ...
 */
async function batchCreateVouchers(merchantId, vouchersData) {
    const promises = vouchersData.map(async (voucherData) => {
        try {
            const result = await exports.voucherManagementService.createVoucher(merchantId, voucherData);
