...
class ReservationService {
     ...
     */
    static async getReservationDetail(id) {
        return await (0, request_1.request)({
     ...
     */
    static async addDishes(id, items) {
        return await (0, request_1.request)({
     ...
     */
    static async modifyDishes(id, items) {
        return await (0, request_1.request)({
     ...
     */
    static async precheckDiningSession(tableId) {
        return await (0, request_1.request)({
     ...
     */
    static async openDiningSession(params) {
        return await (0, request_1.request)({
     ...
     */
    static async getMerchantReservations(params) {
        return await (0, request_1.request)({
     ...
     */
    static async merchantCreateReservation(data) {
        return await (0, request_1.request)({
