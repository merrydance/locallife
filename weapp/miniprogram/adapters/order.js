...
class OrderAdapter {
    ...
    static toViewModel(dto) {
        ...
        const statusHint = (_a = dto.status_hint) === null || _a === void 0 ? void 0 : _a.trim();
...
function formatDeliveryWindow(estimatedAt, etaMinutes) {
    const paddingMinutes = 5;
    if (estimatedAt) {
        const target = (0, dayjs_1.default)(estimatedAt);
        if (!target.isValid())
            return undefined;
