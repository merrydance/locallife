...
exports.DEBUG_CONFIG = exports.CACHE_CONFIG = exports.LOG_CONFIG = exports.ERROR_CONFIG = exports.API_CONFIG = exports.ENV = void 0;
// 检测环境
exports.ENV = {
...
exports.LOG_CONFIG = {
    ...
    // 是否上报远程日志
    REMOTE_ENABLED: exports.ENV.isProd,
    // 日志级别: debug, info, warn, error
    LEVEL: exports.ENV.isDev ? 'debug' : 'info'
};
// 缓存配置
...
exports.DEBUG_CONFIG = {
    ...
    MOCK_ENABLED: false,
    // 是否显示性能监控
    PERFORMANCE_MONITOR: exports.ENV.isDev,
    // 是否显示网络请求日志
    LOG_NETWORK: exports.ENV.isDev,
    // 是否启用调试面板
    DEBUG_PANEL: exports.ENV.isDev
};
exports.default = {
    ENV: exports.ENV,
    API_CONFIG: exports.API_CONFIG,
    ERROR_CONFIG: exports.ERROR_CONFIG,
    LOG_CONFIG: exports.LOG_CONFIG,
    CACHE_CONFIG: exports.CACHE_CONFIG,
    DEBUG_CONFIG: exports.DEBUG_CONFIG
};
