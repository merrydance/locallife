...
exports.DEFAULT_DEMO_MERCHANT = exports.MOCK_PACKAGES = exports.LIUYANGHE_DISHES = exports.HUAXI_DISHES = exports.FEITENGXIAN_DISHES = exports.FUKELA_DISHES = exports.OTHER_MERCHANTS = exports.NIUMENYAN_REVIEWS = exports.NIUMENYAN_DISHES = exports.NIUMENYAN_CATEGORIES = exports.NIUMENYAN_MERCHANT = void 0;
exports.getAllMerchants = getAllMerchants;
exports.getAllDishesForFeed = getAllDishesForFeed;
exports.getMerchantById = getMerchantById;
exports.getCategoriesByMerchantId = getCategoriesByMerchantId;
exports.getDishesByMerchantId = getDishesByMerchantId;
exports.getDishById = getDishById;
exports.getReviewsByMerchantId = getReviewsByMerchantId;
...
exports.NIUMENYAN_DISHES = [
    // 热销
    {
        ...
        category_id: 'cat_hot',
        category_name: '热销',
        merchant_id: exports.NIUMENYAN_MERCHANT.id,
        merchant_name: exports.NIUMENYAN_MERCHANT.name,
        merchant_short_name: exports.NIUMENYAN_MERCHANT.short_name,
        month_sales: 856,
        rating: 49, // 4.9分
        tags: ['招牌', '人气Top1'],
...
exports.MOCK_PACKAGES = [
    {
        id: 'pkg_001',
        name: '双人牛肉套餐',
        shop_name: '牛门宴',
        shop_id: exports.NIUMENYAN_MERCHANT.id,
        image_url: DEMO_IMAGES.dish1,
        price: 9800,
...
function getAllMerchants() {
    return [exports.NIUMENYAN_MERCHANT, ...exports.OTHER_MERCHANTS];
}
/**
 * 获取商家菜品映射
 */
function getMerchantDishesMap() {
    return {
        [exports.NIUMENYAN_MERCHANT.id]: exports.NIUMENYAN_DISHES,
        'merchant_fukela': exports.FUKELA_DISHES,
        'merchant_feitengxian': exports.FEITENGXIAN_DISHES,
        'merchant_huaxi': exports.HUAXI_DISHES,
        'merchant_liuyanghe': exports.LIUYANGHE_DISHES
    };
}
/**
 * 获取商家满返规则（针对代取费的返现）
 */
function getMerchantDiscountRule(merchant) {
 ...
 * 获取所有菜品（Feed格式）
 */
function getAllDishesForFeed() {
    const allDishes = [];
    const merchants = getAllMerchants();
    const dishesMap = getMerchantDishesMap();
    function mapDishToFeed(dish, merchant) {
        return {
            id: dish.id,
            name: dish.name,
 ...
 * 根据商家ID获取分类
 */
function getCategoriesByMerchantId(merchantId) {
    if (merchantId === exports.NIUMENYAN_MERCHANT.id) {
        return exports.NIUMENYAN_CATEGORIES;
    }
    // 其他商家返回默认分类
    return [
        { id: 'cat_hot', name: '热销', sort: 0 },
 ...
 * 根据商家ID获取评价
 */
function getReviewsByMerchantId(merchantId) {
    if (merchantId === exports.NIUMENYAN_MERCHANT.id) {
        return exports.NIUMENYAN_REVIEWS;
    }
    return [];
}
/**
...
function getAllPackages() {
    return exports.MOCK_PACKAGES;
}
// 导出默认的演示商家（牛门宴）
exports.DEFAULT_DEMO_MERCHANT = exports.NIUMENYAN_MERCHANT;
