...
class Navigation {
    ...
    /**
       * 跳转到商户详情页
       */
    static toRestaurantDetail(merchantId) {
        wx.navigateTo({
    ...
    /**
       * 跳转到订单确认页
       */
    static toOrderConfirm(cartData) {
        const url = cartData
    ...
    /**
       ...
       */
    static toAddressEdit(addressId) {
        const url = addressId
    ...
    /**
       ...
       */
    static toReservationDetail(reservationId) {
        wx.navigateTo({
    ...
    /**
       * 跳转到骑手任务详情
       */
    static toRiderTaskDetail(taskId) {
        wx.navigateTo({
