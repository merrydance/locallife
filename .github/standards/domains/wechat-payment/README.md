...
3. the capability-group-specific matrix or checklist for the active change
4. `WECHAT_PAYMENT_OPERATIONS_RUNBOOK_2026-03-24.md` only when operations, recovery, or production handling are in scope
