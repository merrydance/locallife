...
| Mini Program UI | `.github/standards/weapp/README.md`, `.github/standards/weapp/INTERACTION_STANDARDS.md`, `.github/standards/weapp/PERFORMANCE_PRELOAD_STANDARDS.md`, `.github/standards/weapp/API_INTERACTION_CONTRACT.md` | `weapp-mini-program`, `weapp-pages`, `weapp-components` | `general-implementation`, `general-review`, `weapp-implementation`, `weapp-review`, `weapp-page-refactor-blueprint`, `weapp-payment-flow` | Covered |
